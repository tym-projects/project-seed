...
test('provides the four natural and social banks with the approved questions', () => {
  ...
  assert.deepEqual(Object.fromEntries(Object.entries(all).map(([name, questions]) => [name, questions.length])), {
    jiejieNaturalScience: 12,
    jiejieSocialStudies: 12,
    meimeiNaturalScience: 4,
    meimeiSocialStudies: 10,
  });

  const questions = Object.values(all).flat();
  assert.equal(questions.length, 38);
  assert.equal(new Set(questions.map(({ id }) => id)).size, 38);
...
test('keeps each student and subject bank isolated to its approved question ids', () => {
  const expected = {
    jiejieNaturalScience: ['jiejie-natural-science-1', 'jiejie-natural-science-2', 'jiejie-natural-science-3', 'jiejie-natural-science-4', 'jiejie-natural-science-5', 'jiejie-natural-science-6', 'jiejie-natural-science-7', 'jiejie-natural-science-8', 'jiejie-natural-science-9', 'jiejie-natural-science-10', 'jiejie-natural-science-11', 'jiejie-natural-science-12'],
    jiejieSocialStudies: ['jiejie-social-studies-1', 'jiejie-social-studies-2', 'jiejie-social-studies-3', 'jiejie-social-studies-4', 'jiejie-social-studies-5', 'jiejie-social-studies-6', 'jiejie-social-studies-7', 'jiejie-social-studies-8', 'jiejie-social-studies-9', 'jiejie-social-studies-10', 'jiejie-social-studies-11', 'jiejie-social-studies-12'],
    meimeiNaturalScience: ['meimei-natural-science-1', 'meimei-natural-science-2', 'meimei-natural-science-3', 'meimei-natural-science-4'],
    meimeiSocialStudies: ['meimei-social-studies-1', 'meimei-social-studies-2', 'meimei-social-studies-3', 'meimei-social-studies-4', 'meimei-social-studies-5', 'meimei-social-studies-6', 'meimei-social-studies-7', 'meimei-social-studies-8', 'meimei-social-studies-9', 'meimei-social-studies-10'],
  };
...
test('validates unique answer indexes, option answers, and balanced answer positions', () => {
  ...
  assert.deepEqual(counts, [9, 15, 9, 5]);
});

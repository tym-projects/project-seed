...
test('Sprint 30 additions remain isolated to their approved student and subject banks', () => {
  ...
  assert.deepEqual(Array.from(loadQuestions('jiejie-social-studies').filter(({ id }) => ['jiejie-social-studies-5', 'jiejie-social-studies-6'].includes(id)), ({ id }) => id), [
    'jiejie-social-studies-5',
    'jiejie-social-studies-6',
  ]);
  assert.deepEqual(Array.from(loadQuestions('meimei-social-studies').filter(({ id }) => ['meimei-social-studies-5', 'meimei-social-studies-6'].includes(id)), ({ id }) => id), [

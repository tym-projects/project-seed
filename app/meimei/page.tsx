          ...
          {subjects.map(({ subject, label, actions }) => (
            <section key={subject} className="rounded-xl border border-green-100 p-3">
              ...
              <div className="mt-2 grid gap-2 sm:grid-cols-3">
                ...
                <a href={actions.exam} className="rounded-lg border border-green-200 bg-green-50 px-3 py-2 text-center font-bold hover:bg-green-100 hover:text-green-600">第一次月考</a>
